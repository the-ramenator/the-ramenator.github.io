...
window.addEventListener('load', () => {
    ...
    Block(Vector2D(700, 400), Vector2D(500, 60));
    Block(Vector2D(1400, 400), Vector2D(500, 60));
    Block(Vector2D(1900, 250), Vector2D(500, 60));
    Block(Vector2D(1900, 2050), Vector2D(500, 60));
    Enemy(Vector2D(1400,-400));
    Enemy(Vector2D(460,-100));
    Enemy(Vector2D(1900,-250));
    Enemy(Vector2D(1900,-350));
    Enemy(Vector2D(1900,-450));
